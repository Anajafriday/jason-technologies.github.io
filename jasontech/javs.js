            ...
            let showNumOfLikes = document.getElementById("like-info")
            let countLikes = 0
            let numOflikes = countLikes
          
            function runLikeButton(){
             if(countLikes == 0){
                 countLikes++
                 showNumOfLikes.textContent = countLikes
             }else if (numOflikes>= countLikes){
                  countLikes = 1
                  showNumOfLikes.textContent = countLikes
             }
            ...
            likeButton.addEventListener("click",runLikeButton)
            console.log(runLikeButton())